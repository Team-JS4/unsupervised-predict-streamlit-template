...
def main():
    ...
    page_options = ["Welcome","About","EDA","Recommender System","Search for a movie","Solution Overview","Reviews","About Us"]
    ...
    if page_selection == "Recommender System":
        # Header contents
        st.write('# Movie Recommender MM2 JHB')
    ...
    if page_selection == 'EDA':
        ...
        st.image('resources/imgs/total movies.png', use_column_width=True)
        st.markdown('This graph shows the number of movies released per year')
        st.markdown('--------')

        st.image('resources/imgs/movie director.png', use_column_width=True)
        ...
        st.image('resources/imgs/d of w movie title.png', use_column_width=True)
        st.markdown('The visual above shows which words are commonly used when movies are titled')
        st.markdown('--------')

        st.image('resources/imgs/d of w movie title.png', use_column_width=True)
        st.markdown('This visual shows popular directors')
    ...
    if page_selection == 'About Us':
        ...
        st.markdown("")
        st.info("Palesa Kheswa")
        st.markdown("* Github account:DineoPalesa")
        st.markdown("* Kaggle account:Palesa Kheswa")
        st.markdown("* email:palesadkheswa@gmail.com")
        st.markdown("")

        st.info("Precious Chauke")
        st.markdown("* Github account:Precious1992Explore")
        st.markdown("* Kaggle account:Precious Chauke")
        st.markdown("* email:chaukeprecy@gmail.com")
        st.markdown("")

        st.info("Tshepo Sibanyoni")
        st.markdown("* Github account:Trsiba")
        st.markdown("* Kaggle account:Tshepo Sibanyoni")
        st.markdown("* email:trsiba@gmail.com")
        st.markdown("")

        st.info("Zamangwane Dithebe")
        st.markdown("* Github account:Zdithebe96")
        st.markdown("* Kaggle account:Zamangwane Dithebe")
        st.markdown("* email:zdithebe96@gmail.com")
        st.markdown("")

        st.info("Vuyelwa ")
        #st.markdown("* Github account:")
        st.markdown("* Kaggle account:VuyelwaF")
        st.markdown("* email:vuyelwaf22@gmail.com")
        st.markdown("")

        st.info("Thato Kgoale")
        #st.markdown("* Github account:")
        st.markdown("* Kaggle account:ThatoK")
        st.markdown("* email:kgoalethato19@gmail.com")
        st.markdown("")
